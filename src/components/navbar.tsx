        ...
        <div className="flex items-center justify-between h-16">
          <div className="flex items-center gap-8">
            <Link href="/" className="flex items-center gap-2.5 group">
              ...
              <span className="text-[15px] tracking-tight flex items-baseline gap-[2px]">
                <span className="font-mono font-medium text-[hsl(var(--muted-foreground))] text-[15px]">Stylus</span>
                <span className="font-bold text-[hsl(213,80%,68%)] text-[17px]" style={{ fontFamily: 'var(--font-heading)' }}>Arena</span>
              </span>
            </Link>
